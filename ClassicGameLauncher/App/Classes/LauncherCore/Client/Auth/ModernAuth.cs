...
namespace ClassicGameLauncher.App.Classes.LauncherCore.Client.Auth
{
    class ModernAuth
    {
        ...
        public static void Login(String email, String password)
        {
            ...
            {
                JSONNode LoginObjectResponse;

                try
                {
                    LoginObjectResponse = JSON.Parse(serverLoginResponse);
                }
                catch
                {
                    LoginObjectResponse = JSON.Parse(_serverErrormsg);
                }
        ...
        public static void Register(String email, String password, String token = null)
        {
            ...
            {
                JSONNode RegisterObjectResponse;

                try
                {
                    RegisterObjectResponse = JSON.Parse(serverLoginResponse);
                }
                catch
                {
                    RegisterObjectResponse = JSON.Parse(_serverErrormsg);
                }
